...
The lanes to select from are indicated using the immediates, with indices $f [0-15]$ referring to the first operand, and $f [16-31]$ referring to the second operand.
